"""Custom tools for the vectoradd CUDA kernel optimization deep agent."""
...
def _update_plot():
    ...
    ax.set_title("GPU MODE vectoradd — Autoresearch Progress", fontsize=14, fontweight="bold")
...
def _update_iteration_plot():
    ...
    ax.set_xlabel("Iteration #", fontsize=12)
    ax.set_ylabel("Negative Latency (-μs)", fontsize=12)
    ax.set_title("GPU MODE vectoradd — Best per Agent Iteration", fontsize=14, fontweight="bold")
    ax.grid(True, alpha=0.3)
